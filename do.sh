...
CFLAGS="-Wall -m32 -O -nostdinc -fno-builtin -fno-stack-protector -fcommon -mno-sse -mno-sse2 -mno-mmx -Wno-implicit-function-declaration -finline-functions -finline-functions-called-once -I./inc/ "
BOCHS="${BOCHS:-bochs}"
